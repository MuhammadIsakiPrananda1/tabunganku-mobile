          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _targetBudget > 0
                      ? 'Target Anggaran (Kebutuhan: Rp ${NumberFormat.decimalPattern('id_ID').format(_totalEstimatedCost.round())})'
                ...
                Row(
                  children: [
                    _StatCell(
                      label: 'TERKUMPUL',
                      value: NumberFormat.currency(locale: 'id_ID', symbol: 'Rp ', decimalDigits: 0).format(_savedAmount),
                      color: Colors.teal,
                    ),
                    Container(
                      width: 1,
                    ...
                    _StatCell(
                      ...
                      value: _targetDate != null
                          ? 'Rp ${NumberFormat.decimalPattern('id_ID').format(_recommendedMonthlySavings.round())}'
                          : '-',
                    ...
                    _StatCell(
                      label: 'SISA WAKTU',
                      value: _targetDate != null ? '$_monthsRemaining Bln' : '-',
                      color: isDarkMode ? Colors.white70 : Colors.black87,
                    ),
                  ],
                ),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Icon(Icons.add_card_rounded, size: 14),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          showTopToast(context, 'Rencana pernikahan berhasil disimpan!');
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: accentColor,
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
